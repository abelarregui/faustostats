...
def calc_payment_table(df_weeks):
    ...
    df_weeks_pivot_lite=df_weeks_pivot['cumsum_profit_week'][['Czech Liga Pro_.9 apuestes','TT Elite Series_.93 apuestes']]
    df_weeks_pivot_lite.fillna(0, inplace=True)
    df_weeks_pivot_lite['week_balance'] = df_weeks_pivot_lite['Czech Liga Pro_.9 apuestes'] + df_weeks_pivot_lite['TT Elite Series_.93 apuestes']
